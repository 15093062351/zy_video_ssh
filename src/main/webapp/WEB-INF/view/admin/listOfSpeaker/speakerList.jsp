...
<script type="text/javascript" src="${pageContext.request.contextPath }/ss/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/ss/js/jquery-confirm.min.js"></script>
	 ...
	 $.confirm({
		    ...
		    buttons: {   
		        ok: {
		            ...
		            action: function(){
		               location.href = "${pageContext.request.contextPath }/json/deleteSpeaker?id="+id;
		            }
		        },
		        cancel:{
		        	text: "取消"
	 ...
	 $.confirm({
		    ...
		    buttons: {
		        confirm: {
		        	...
		        	action: function () {
		           		$.ajax({
		           			url:"${pageContext.request.contextPath}/json/deleteSpeaker",
		           			dataType:"json",
		           			type:"post",
		           			data:{"id":id},
...
<body>
 <!-- 引入公用的导航信息 -->
	...
	<div class="container">
		...
		<div class="row"><a href="${pageContext.request.contextPath }/Speaker/speakeradd" class="btn btn-primary">添加主讲人</a>
		<div style="float: right;">
			<form class="form-inline" action="${pageContext.request.contextPath }/Speaker/speakerList" method="post">
 			...
 			<tbody>
 					<c:forEach items="${pages.rows }" var="sp" varStatus="i">
		 				<tr>
		 					...
		 					<td><a href="${pageContext.request.contextPath }/Speaker/updateSpeaker?id=${sp.id }"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
            		<td><a  onclick="deleteSpeaker(${sp.id})" href="#"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
		 				</tr>
	 				</c:forEach>
 			</tbody>
		</table>
		<lyb:page url="${pageContext.request.contextPath }/Speaker/speakerList"></lyb:page>
	</div>
</body>
</html>