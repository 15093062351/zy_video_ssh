	...
	<div class="body">
		<div style="width: 60%;">
			<form class="form-horizontal"
				action="${pageContext.request.contextPath }/Course/editcoursebaocun"
				method="post">
					...
					<div class="col-sm-10">
						...
						<select name="subjectId" style="width: 650px; height: 40px;">
							...
							<c:forEach var="list" items="${list}" varStatus="status">
								<option value="${list.id}" ${course2.subjectId eq list.id ? "selected":""}>${list.subjectName}</option>
							</c:forEach> 
						</select>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputPassword3"
							placeholder="课程标题" name="courseName" value="${course2.courseName }">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="inputEmail3"
							placeholder="课程简介" name="courseDescr" value="${course2.courseDescr }">
					</div>
				</div>
				<input type="hidden" name="id" value="${course2.id }">
				<div class="form-group">
