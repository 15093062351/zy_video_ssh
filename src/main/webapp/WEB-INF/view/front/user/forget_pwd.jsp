...
<head>
    ...
    <link rel="stylesheet" href="ss/css/forget_password.css">
...
<body>
    <header>
        <div class="container">
            <img src="ss/img/logo.png" alt="智游">
        </div>
    </header>
    <main>
        <div class="container">
            <form class="ma" action="front/reset_pwd" method="post" >
...
<%@include file="../include/script.html"%>
    <script type="text/javascript">
		function submitEmail(){
			...
			//改为ajax提交邮箱
			if(email!=null&&email!=''){
				$.post('front/sendemail',{email:email},function(result){
					console.log(result);
					if(result.success){
