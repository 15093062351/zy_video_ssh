...
<head>
    ...
    <link rel="stylesheet" href="ss/css/base.css">
    <link rel="stylesheet" href="ss/css/profile.css">
...
<body>
   <jsp:include page="uheader.jsp"></jsp:include>
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="front/profile">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front/avatar">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="front/password">密码安全</a></li>
                </ul>
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.headUrl}">
		                         <img id="avatar" src="ss/img/avatar_lg.png" alt="">
		                      </c:if>
    ...
    <footer>
        <div class="container">
            <ul>
                <li><img src="ss/img/footer_logo.png" alt="" id="foot_logo"></li>
                <li>版权所有：智游3G教育&#x3000;&#x3000;&#x3000;&copy;&nbsp;www.zhiyou100.com</li>
                <li><img src="ss/img/微信公众号.png" alt="" id="wxgzh"></li>
            </ul>
        </div>
    </footer>
</body>
