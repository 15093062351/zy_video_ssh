...
<footer>
	<ul>
		<li>
			<img src="ss/img/footer_logo.png" alt="" draggable="false">
		</li>
		<li class="mt25">
			<h3>各校区地址</h3>
			<ul>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="ss/img/微信公众号.png" alt="" draggable="false">
						<img class="weibo" src="ss/img/微博公众号.png" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
...
<div class="mask hidden" id="loginDiv">
	<div class="mask_content">
		<div class="mask_content_header">
			<img src="ss/img/logo.png" alt="" class="ma">
		</div>
		<div class="mask_content_body">
			<form id="loginForm" method="post">
				...
				<div id="forget">
					<a href="front/forget_pwd">忘记密码？</a>
				</div>
